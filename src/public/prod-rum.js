      ...
      2: [
        function(t, e, n) {
          ...
          try {
            ...
            'stack' in h &&
              (t(9), t(8), 'addEventListener' in window && t(5), s.xhrWrappable && t(10), (d = !0))
          }
          ...
          var h = (r.prototype = {
            createTracer: function(t, e) {
              ...
              return (
                ...
                function() {
                  if ((s.emit((i ? '' : 'no-') + 'fn-start', [f.now(), r, i], n), i))
                    try {
      ...
      23: [
        function(t, e, n) {
          ...
          'undefined' != typeof document.hidden
            ? ((i = 'hidden'), (o = 'visibilitychange'), (a = 'visibilityState'))
            : 'undefined' != typeof document.msHidden
            ? ((i = 'msHidden'), (o = 'msvisibilitychange'))
            : 'undefined' != typeof document.webkitHidden &&
              ((i = 'webkitHidden'), (o = 'webkitvisibilitychange'), (a = 'webkitVisibilityState'))
        },
        {},
      ],
      24: [
        ...
        function(t, e, n) {
          ...
          if (d(l.location)) {
            ...
            t(15),
              t(20),
              p[h]
                ? (p[h]('DOMContentLoaded', o, !1), l[h]('load', r, !1))
                : (p[m]('onreadystatechange', i), l[m]('onload', r)),
          ...
          function r(t, e) {
            ...
            function r(t, e, r, i, o) {
              ...
              for (f = 0; f < e.length; f++)
                (s = e[f]), (c = t[s]), a(c) || (t[s] = n(c, u ? s + r : r, i, s, o))
            }
            function c(n, r, o, a) {
              if (!h || e) {
                var c = h
...
NREUM.loader_config = {
  ...
  trustKey: '3030472',
  agentID: '169308567',
  licenseKey: 'NRJS-78b0c80e0762998f0e3',
  applicationID: '169308567',
}
NREUM.info = {
