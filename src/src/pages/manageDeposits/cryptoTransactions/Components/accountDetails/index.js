...
const mapStateToProps = ({ user, general, cryptoTransaction, settings }) => ({
  token: user.token,
  ...
  bankAccountsRequestedToVendorAt:
    cryptoTransaction.selectedTransaction.progressLogs.bankAccountsRequestedToVendorAt,
  bankAccountsReceivedByVendorAt:
    cryptoTransaction.selectedTransaction.progressLogs.bankAccountsReceivedByVendorAt,
