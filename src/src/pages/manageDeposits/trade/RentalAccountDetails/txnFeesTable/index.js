...
class TxnFeesTable extends Component {
  ...
  render() {
    const { fees, vendors, currencies, timeZone } = this.props
    ...
    const swapFeesColumns = [
      ...
      },
      {
        ...
        align: 'center',
        inputType: 'select',
        options: [{ id: '11', value: 'rendal_account_fee', title: 'RENTAL ACCOUNT FEE' }],
      },
      {
        title: 'Account Type',
        ...
        options: [
          ...
          { id: '22', value: 'accounts_only', title: 'RENTAL ACCOUNT' },
        ],
      },
      {
        title: 'Account',
