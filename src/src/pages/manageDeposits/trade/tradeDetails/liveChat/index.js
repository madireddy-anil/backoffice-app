...
const mapStateToProps = ({ user, trade, chat, settings }) => ({
  token: user.token,
  email: user.email,
  name: user.name,
  ...
  channelStatus: trade.chat.channelStatus,
  ...
  visibleMembers: chat.visibleMembers,
  visibleAddMember: chat.visibleAddMember,
  timeZone: settings.timeZone.value,
  activeCurrentTradeChatChannel: chat.activeCurrentTradeChatChannel,
