...
const mapStateToProps = ({ settings, user, transactions, trade }) => ({
  token: user.token,
  isEditTxnMode: transactions.isEditTxnMode,
  transactionId: transactions.selectedTransaction.id,
  txnConfirmRemittedFundsLoading: transactions.txnConfirmRemittedFundsLoading,
  settlementCurrency: transactions.selectedTransaction.settlementCurrency,
  isRemittedFundsConfirmed: transactions.isRemittedFundsConfirmed,
  fundReceiptConfirmAmountByClient: transactions.selectedTransaction.settlementAmount,
  fundReceiptConfirmDateByClient:
    transactions.selectedTransaction.progressLogs.fundsRemittedByVendorAt,
  txnDateTime: transactions.selectedTransaction.progressLogs.transactionRequestedAt,
  ...
  amountSold: transactions.selectedTransaction.amountSold,
