...
const mapStateToProps = ({ general, transactions, user, trade, settings }) => ({
  token: user.token,
  vendors: general.newVendors,
  selectedVendor: transactions.selectedVendor,
  localDepositAccounts: transactions.selectedTransaction.localDepositAccounts,
  progressLogs: trade.progressLogs,
  selectedAccountNames: transactions.selectedAccountNames,
  bankAccounts: general.bankAccounts,
  allBankAccounts: transactions.allBankAccounts,
  selectedTransaction: transactions.selectedTransaction,
  isTransactionDetailsFetched: transactions.isTransactionDetailsFetched,
  updateBankAccLoading: transactions.updateBankAccLoading,
