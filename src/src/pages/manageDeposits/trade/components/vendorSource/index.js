...
import { updateTxnSourceAmount, updateTxnSourceCurrency } from 'redux/transactions/actions'

import Beneficiary from '../vendorBeneficiary'

import styles from './style.module.scss'

const mapStateToProps = ({ settings, transactions }) => ({
  timeZone: settings.timeZone.value,
  sourceAmount: transactions.selectedTransaction.sourceAmount,
  sourceCurrency: transactions.selectedTransaction.sourceCurrency,
})
