...
class FxDetails extends Component {
  editTransaction = () => {
      ...
      <Menu>
        ...
        <Menu.Item
          hidden={
            ...
            selectedVendor?.vendorType === 'non_safe_gaurded'
          }
          onClick={this.showMembers}
        >
          <Icon type="eye" />
          Pc Margin Calculation
        </Menu.Item>
      </Menu>
    )
        ...
        <Card
          ...
          extra={
            <>
              ...
              <Dropdown overlay={fxTxnActionMenu} trigger={['click']}>
                <Icon type="setting" />
              </Dropdown>
            </>
          }
        >
          <Row>
            ...
            <Col xs={{ span: 24 }} lg={{ span: 11 }}>
              <div>{isChatSelected ? <FxChat /> : <FxSummary />}</div>
            </Col>
          </Row>
        </Card>
        <RouteEngineTable />
