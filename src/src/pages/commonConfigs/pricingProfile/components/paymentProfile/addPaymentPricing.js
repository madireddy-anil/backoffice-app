...
import { Button, Form, Select, InputNumber, Card, Radio, Checkbox } from 'antd'
...
class NewPaymentPricing extends Component {
  ...
  componentDidMount() {
    const { dispatch, addMoreTiering } = this.props
    if (!addMoreTiering) {
  ...
  handlePaymentRecordSubmit = event => {
    ...
    form.validateFields((error, values) => {
      ...
      if (!error) {
        ...
        // dispatch(updatePaymentTieringMethodSelected(values.tieringMethod))
  ...
  render() {
    const { form, isPaymentTier, selectedPaymentTieringMethod, addMoreTiering } = this.props
      ...
      <Form onSubmit={this.handlePaymentRecordSubmit}>
        {addMoreTiering ? (
          <Card
            title={
              isPaymentTier ? (
                <p> Add more {selectedPaymentTieringMethod} Tiering </p>
              ) : (
          ...
          >
            <div className="row">
              <div className="col-md-6 col-lg-12">
                <Form.Item>
                  {form.getFieldDecorator('paymentsTier', {
                    // rules: [{ required: true, message: 'Please select profile type' }],
                  })(
              ...
              <div className="row">
                <div className="col-md-6 col-lg-4">
                  <Form.Item hasFeedback>
                    {form.getFieldDecorator('paymentsTieringMethod', {
