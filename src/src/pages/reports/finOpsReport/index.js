...
class FinOpsReport extends Component {
  ...
  componentWillUnmount() {
    ...
    ClearFilterOnComponentUnMount('', handleFinOpsReportFilters, dispatch)
  }
                ...
                {getFieldDecorator('DateAndTimeOfTrade')(
                  <RangePicker
                    ...
                    onCalendarChange={evt =>
                      dateRangeResetAfterReset(evt, appliedFilters.DateAndTimeOfTrade)
                    }
  ...
  handleTableColumns = () => {
    ...
    const columns = [
      ...
      },
      {
        ...
        // align: 'center',
        width: 150,
        render: data => (data.length !== 0 ? data.join() : nullSymbol),
      },
    ]
