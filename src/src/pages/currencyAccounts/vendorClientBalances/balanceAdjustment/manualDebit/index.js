...
import { initiateVendorClientManualDebit } from 'redux/caBalanceAdjustments/actions'
...
class ManualDebit extends React.Component {
  ...
  onSubmitHandle = () => {
    ...
    dispatch(initiateVendorClientManualDebit(selectedAccountDetails.id, value, token))
  }
  ...
  handleAuthroizePayment = event => {
    ...
    form.validateFields((error, values) => {
      if (!error) {
        ...
        dispatch(initiateVendorClientManualDebit(parameters, token))
      }
    })
  }
