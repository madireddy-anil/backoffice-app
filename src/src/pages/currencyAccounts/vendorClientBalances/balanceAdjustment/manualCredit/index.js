...
import { initiateVendorClientManualCredit } from 'redux/caBalanceAdjustments/actions'
...
class ManualCredit extends React.Component {
  ...
  onSubmitHandle = () => {
    ...
    dispatch(initiateVendorClientManualCredit(selectedAccountDetails.id, value, token))
  ...
  handleAuthroizePayment = event => {
    ...
    form.validateFields((error, values) => {
      if (!error) {
        ...
        dispatch(initiateVendorClientManualCredit(parameters, token))
      }
    })
  }
