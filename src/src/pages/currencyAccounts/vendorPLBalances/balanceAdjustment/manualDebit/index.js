...
import { initiateVendorPLManualDebit } from 'redux/caBalanceAdjustments/actions'
...
class ManualDebit extends React.Component {
  ...
  onSubmitHandle = () => {
    ...
    dispatch(initiateVendorPLManualDebit(selectedAccountDetails.id, value, token))
  ...
  handleAuthroizePayment = event => {
    ...
    form.validateFields((error, values) => {
      if (!error) {
        ...
        dispatch(initiateVendorPLManualDebit(parameters, token))
      }
    })
  }
