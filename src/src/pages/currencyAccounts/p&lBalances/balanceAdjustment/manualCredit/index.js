...
import { initiatePandLManualCredit } from 'redux/caBalanceAdjustments/actions'
...
class ManualCredit extends React.Component {
  ...
  onSubmitHandle = () => {
    ...
    dispatch(initiatePandLManualCredit(selectedAccountDetails.id, value, token))
  }
  ...
  handleAuthroizePayment = event => {
    ...
    form.validateFields((error, values) => {
      if (!error) {
        ...
        dispatch(initiatePandLManualCredit(parameters, token))
      }
    })
  }
