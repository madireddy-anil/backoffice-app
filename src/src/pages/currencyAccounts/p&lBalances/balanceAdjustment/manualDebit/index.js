...
import { initiatePandLManualDebit } from 'redux/caBalanceAdjustments/actions'
...
class ManualDebit extends React.Component {
  ...
  onSubmitHandle = () => {
    ...
    dispatch(initiatePandLManualDebit(selectedAccountDetails.id, value, token))
  ...
  handleAuthroizePayment = event => {
    ...
    form.validateFields((error, values) => {
      if (!error) {
        ...
        dispatch(initiatePandLManualDebit(parameters, token))
      }
    })
  }
