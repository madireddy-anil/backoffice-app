...
import { deleteAccountThreshold } from 'redux/currencyAccounts/action'
...
class viewAccountDetails extends Component {
  ...
  handleDeletedThreshold = thresholdId => {
    ...
    dispatch(deleteAccountThreshold(selectedCurrencyAccount.id, thresholdId, token))
  }
        ...
        render: record => (
          <>
            <Popconfirm
              ...
              onConfirm={() => this.handleDeletedThreshold(record._id)}
              okText="Yes"
              cancelText="No"
