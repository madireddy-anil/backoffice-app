...
import {
  ...
  deleteVendorClientPaymentAccount,
} from 'redux/currencyAccounts/action'
import { getVendorsName, getCompanyName, formatToZoneDate } from 'utilities/transformer'
...
class viewCAInitialData extends Component {
  ...
  handleDeleteAccount = accountId => {
    ...
    dispatch(deleteVendorClientPaymentAccount(accountId, token))
  }
  ...
  render() {
    const { selectedCurrencyAccount, vendors, companies, timeZone } = this.props
