...
class addNewCurrencyAccount extends Component {
  ...
  onSubmit = event => {
    ...
    const { currencyData, isFormAutoGenerateBank, mainCurrencyData } = this.state
      ...
      if (
        ...
        if (!error) {
          const value = {
            ...
            isNetworkFeeAccount: false,
            isTreasury: values.isTreasury === 'yes' || false,
            suspenseAccount: values.suspenseAccount === 'yes' || false,
          ...
          dispatch(addVendorClientPaymentAccount(value, token))
        }
      } else {
        notification.error({
    ...
    return (
      <Spin spinning={companiesListLoading || clientListloading || vendorListLoading}>
        <Card
          title={
            <div>
              <span className="font-size-16">New Vendor Client Payment Account</span>
            </div>
          }
          bordered
          headStyle={{
          ...
          <React.Fragment>
            ...
            <Form layout="vertical" onSubmit={this.onSubmit}>
              <div className="row">
                ...
                {/* <div className="col-md-6 col-lg-3">
                  <Form.Item label="Network Fee Account " hasFeedback>
                    {form.getFieldDecorator('isNetworkFeeAccount', {
                      initialValue: 'yes',
                      rules: [{ required: true, message: 'Please select  Network Fee Account ' }],
                    })(
                      <Select
                        showSearch
                        optionFilterProp="children"
                        optionLabelProp="label"
                        placeholder="Please select Network Fee Account "
                        filterOption={(input, option) =>
                          option.props.label
                            ? option.props.label.toLowerCase().indexOf(input.toLowerCase()) >= 0
                            : ''
                ...
                <div className="col-md-6 col-lg-3">
                  <Form.Item label="Suspense Account Required" hasFeedback>
                    {form.getFieldDecorator('suspenseAccount', {
                      initialValue: 'no',
                      rules: [{ required: true, message: 'Please select suspense account' }],
                    })(
                      <Select
                        showSearch
                        optionFilterProp="children"
                        optionLabelProp="label"
                        placeholder="Please select suspense account"
                        filterOption={(input, option) =>
                          option.props.label
                            ? option.props.label.toLowerCase().indexOf(input.toLowerCase()) >= 0
                            : ''
                      ...
                      <React.Fragment>
                        ...
                        <div className="col-md-3 col-lg-3">
                          <Form.Item label="IBAN" hasFeedback>
                            {form.getFieldDecorator('IBAN', {})(<Input placeholder="Enter IBAN" />)}
                          </Form.Item>
                        </div>
                        <div className="col-md-3 col-lg-3">
