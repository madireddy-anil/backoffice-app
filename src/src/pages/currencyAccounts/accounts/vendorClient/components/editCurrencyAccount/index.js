            ...
            <Card
              title={
                <div>
                  ...
                  />
                  <span className="font-size-16">Edit Vendor Client Currency Account</span>
                </div>
              }
              bordered
              headStyle={{
            ...
            >
              ...
              >
                ...
                <Panel header="Account Limits" key="2" style={customPanelStyle}>
                  ...
                  {selectedCurrencyAccount.accountThresholds &&
                ...
                >
                  ...
                  Object.entries(selectedCurrencyAccount.exoticForeignExchange).length > 0 ? (
                    ''
                  ) : (
                    <div className={styles.addButtonBlock}>
                      <Button
                  ...
                  {showAddExoticFXConfig || showEditExoticFX ? <AddExoticFXConfig /> : ''}
                  {selectedCurrencyAccount.exoticForeignExchange &&
                  Object.entries(selectedCurrencyAccount.exoticForeignExchange).length > 0 ? (
                    <ViewExoticFXConfig />
                  ) : (
