...
import {
  ...
  addNewSuspenseExternalReference,
  editSuspenseExternalReference,
    ...
    form.validateFields((error, values) => {
      if (!error) {
        if (showAddExternalReference) {
          dispatch(addNewSuspenseExternalReference(selectedCurrencyAccount.id, values, token))
        } else {
          dispatch(
            editSuspenseExternalReference(
          ...
          title={
            <div className={styles.modalHeader}>
              <InfoCard
                ...
                imgTop="43%"
                header={
                  showAddExternalReference ? 'Add External References' : 'Edit External References'
                }
