...
import { updateCAInitialDataEditMode, deletePLPaymentAccount } from 'redux/currencyAccounts/action'
...
class viewCAInitialData extends Component {
  ...
  handleDeleteAccount = accountId => {
    ...
    dispatch(deletePLPaymentAccount(accountId, token))
  }
          ...
          <div className="col-md-6 col-lg-3">
            ...
            <div className="pb-4 mt-1">
              <span className="font-size-13">
                ...
                selectedCurrencyAccount.accountName
              </span>
            </div>
          </div>
          <div className="col-md-6 col-lg-3">
