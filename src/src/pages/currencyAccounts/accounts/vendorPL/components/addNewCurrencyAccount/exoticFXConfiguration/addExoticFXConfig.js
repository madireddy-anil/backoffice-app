...
import {
  ...
  addNewVendorPLExoticFXConfig,
  updateShowEditExoticFX,
  editVendorPLExoticFXConfig,
  ...
  onSubmit = event => {
    ...
    form.validateFields((error, values) => {
      if (!error) {
        ...
        if (showEditExoticFX) {
          dispatch(editVendorPLExoticFXConfig(selectedCurrencyAccount.id, value, token))
        } else {
          dispatch(addNewVendorPLExoticFXConfig(selectedCurrencyAccount.id, value, token))
        }
      }
    })
  }
