...
import {
  ...
  createManualChatChannel,
  endChannel,
} from 'redux/restrictedCurrencies/trade/tradeProcess/chat/actions'
import { deleteTrade } from 'redux/restrictedCurrencies/trade/tradesHistory/actions'

import TradeProgress from './tradeProgress'
import LiveChat from './liveChat'
import TradeSummary from './tradeSummary'

import RouteEngineTable from '../../rcComponents/routeTable'
...
const mapStateToProps = ({ settings, general, npTrade, npChat, user }) => ({
  timeZone: settings.timeZone.value,
  currencies: general.currencies,
  routeEngineData: npTrade.routeEngineData,
  tradeReference: npTrade.tradeReference,
  tradeStatus: npTrade.tradeStatus,
  isChatSelected: npTrade.isChatSelected,
  isChannelCreated: npChat.isChannelCreated,
  ...
  comments: npTrade.comments,
  subStatus: npTrade.subStatus,
  tradeValuesUpdateLoader: npTrade.tradeValuesUpdateLoader,
})
