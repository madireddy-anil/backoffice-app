...
import { updateSelectedVendor } from 'redux/restrictedCurrencies/trade/tradeProcess/transactions/actions'

import styles from './style.module.scss'

const mapStateToProps = ({ user, npTransactions, general }) => ({
  token: user.token,
  ...
  currentRouteType: npTransactions.currentRouteType,
