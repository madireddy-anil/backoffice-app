...
const mapStateToProps = ({ user, general, npTransactions, settings }) => ({
  ...
  bankAccountsRequestedToVendorAt:
    npTransactions.selectedTransaction.progressLogs.bankAccountsRequestedToVendorAt,
  bankAccountsReceivedByVendorAt:
    npTransactions.selectedTransaction.progressLogs.bankAccountsReceivedByVendorAt,
