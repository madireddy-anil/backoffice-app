...
const mapStateToProps = ({ settings, user, npChat, npTrade }) => ({
  token: user.token,
  email: user.email,
  ...
  isFundReceiptConfirmed: npTrade.isFundReceiptConfirmed,
  fundReceiptConfirmAmountByClient: npTrade.fundReceiptConfirmAmountByClient,
  fundReceiptConfirmDateByClient: npTrade.fundReceiptConfirmDateByClient,
  confirmFundsLoader: npTrade.confirmFundsLoader,
  channelId: npTrade.chat.channelId,
  progressLogs: npTrade.progressLogs,
  tradeDateTime: npTrade.progressLogs.tradeRequestedAt,
  isTradeFundRemitted: npTrade.progressLogs.fundsRemittedToClientAt,
