...
import { getTradeById } from 'redux/restrictedCurrencies/trade/tradeProcess/tradeDetails/actions'

import Download from 'components/CleanUIComponents/Download'

import styles from './style.module.scss'

const mapStateToProps = ({ user, npTrade }) => ({
  token: user.token,
  tradeId: npTrade.tradeId,
  bankAccounts: npTrade.localDepositAccounts,
})
