...
const mapStateToProps = ({ user, general, npTrade, settings }) => ({
  token: user.token,
  ...
  updateTradeAmountLoader: npTrade.updateTradeAmountLoader,
  conformDepositLoader: npTrade.conformDepositLoader,
  progressLogs: npTrade.progressLogs,
  tradeDateTime: npTrade.progressLogs.tradeRequestedAt,
  confirmedDepositDateByClient: npTrade.progressLogs.depositConfirmedByClientAt || null,
