...
import { deleteDepositSlip } from 'redux/restrictedCurrencies/trade/tradeProcess/tradeDetails/actions'
import {
...
const mapStateToProps = ({ user, npTrade, upload, settings, npTransactions }) => ({
  token: user.token,
  isEditMode: npTrade.isEditMode,
  tradeId: npTrade.tradeId,
  timeZone: settings.timeZone.value,
  deletionLoadingTrade: npTrade.deletionLoadingTrade,
  deletionLoadingTransactions: npTransactions.deletionLoadingTransactions,
  upload,
})
