...
import routingEngineAction from '../routeEngine/actions'
...
export function* confirmExistingSellRate(values) {
  try {
    ...
    yield put({
      type: actions.NP_CONFIRM_EXISTING_SELL_RATE_SUCESS,
      value: response,
    })
    ...
    yield put({
      type: actions.NP_CONFIRM_EXISTING_SELL_RATE_FAILURE,
      value: err,
    })
    notification.error({
...
function* apiCallAfterTradeFetch(trade, token) {
  try {
    ...
    if (trade.cryptoBeneficiary) {
      yield put({
        type: newTradeActions.NP_GET_BENEFICIARY_CRYPTO_BY_CLIENT_ID,
        value: trade.clientId,
        token,
      })
    } else {
      yield put({
        type: newTradeActions.NP_GET_BENEFICIARY_BY_CLIENT_ID,
        value: trade.clientId,
        token,
      })
    }
...
export function* getTradeDetailsById(values) {
  try {
    ...
    yield put({
      type: actions.NP_GET_TRADE_DETAILS_BY_ID_SUCCESS,
      value: response,
    })
    yield call(apiCallAfterTradeFetch, response, values.token)
  } catch (err) {
    yield put({
      type: actions.NP_GET_TRADE_DETAILS_BY_ID_FAILURE,
      payload: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* getRouteByTradeId(values) {
  try {
    ...
    yield put({
      type: actions.NP_GET_ROUTE_BY_TRADE_ID_SUCCESS,
      value: response.tradeRouters,
    })
  } catch (err) {
    yield put({
      type: actions.NP_GET_ROUTE_BY_TRADE_ID_FAILURE,
      payload: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* updateRouteById(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_ROUTE_VALUE_SUCCESS,
      value: response,
    })
    // yield put({
    //   type: actions.NP_GET_ROUTE_BY_TRADE_ID,
    ...
    yield put({
      type: actions.NP_UPDATE_ROUTE_VALUE_FAILURE,
      payload: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* updateTradeClient(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_SELECTED_CLIENT_SUCCESS,
      value: response,
    })
    yield put({
      type: newTradeActions.NP_GET_BENEFICIARY_BY_CLIENT_ID,
    ...
    yield put({
      type: actions.NP_UPDATE_SELECTED_CLIENT_FAILURE,
      payload: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* updateSourceDetails(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_SOURCE_DETAILS_SUCCESS,
      value: response,
    })
    yield put({
      type: actions.NP_GET_ROUTE_BY_TRADE_ID,
    ...
    yield put({
      type: actions.NP_UPDATE_SOURCE_DETAILS_FAILURE,
      payload: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* updateBeneficiaryDetails(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_BENEFICIARY_DETAILS_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_UPDATE_BENEFICIARY_DETAILS_FAILURE,
      payload: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* updateDepositDetails(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_DEPOSITED_AMOUNT_SUCCESS,
      value: response,
    })
    yield put({
      type: actions.NP_GET_ROUTE_BY_TRADE_ID,
    ...
    yield put({
      type: actions.NP_UPDATE_DEPOSITED_AMOUNT_FAILURE,
      payload: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* updateTradeAmountAsDeposit(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_TRADE_AMOUNT_SUCCESS,
      value: response,
    })
    ...
    yield put({
      type: actions.NP_UPDATE_TRADE_AMOUNT_FAILURE,
      payload: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* confirmFinalFundsByClient(values) {
  try {
    ...
    yield put({
      type: actions.NP_CONFIRM_FINAL_FUNDS_SUCCESS,
      value: response,
    })
    ...
    yield put({
      type: actions.NP_CONFIRM_FINAL_FUNDS_FAILURE,
      payload: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* createManualRoute(values) {
  try {
    ...
    yield put({
      type: actions.NP_CREATE_MANUAL_ROUTE_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_CREATE_MANUAL_ROUTE_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* onRouteChange(value) {
  try {
    ...
    if (value.values.isCrypto) {
      yield put({
        type: transactionAction.NP_CREATE_CRYPTO_TRANSACTION,
        value: value.values.forTrasactionCreation,
        token: value.token,
      })
    } else {
      yield put({
        type: transactionAction.NP_CREATE_TRANSACTION,
        value: value.values.forTrasactionCreation,
        token: value.token,
      })
    }
...
export function* autoCreateRoute(values) {
  try {
    ...
    yield put({
      type: actions.NP_CREATE_ROUTE_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_CREATE_ROUTE_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* updateRouteOnCancelTxn(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_ROUTE_ON_CANCEL_TXN_SUCCESS,
      value: response,
    })
    // yield put({
    //   type: actions.NP_GET_ROUTE_BY_TRADE_ID,
    ...
    yield put({
      type: actions.NP_UPDATE_ROUTE_ON_CANCEL_TXN_FAILURE,
      payload: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* updateRouteOnDeleteTxn(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_ROUTE_ON_DELETE_TXN_SUCCESS,
      value: response,
    })
    yield put({
      type: actions.NP_GET_ROUTE_BY_TRADE_ID,
    ...
    yield put({
      type: actions.NP_UPDATE_ROUTE_ON_DELETE_TXN_FAILURE,
      payload: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* updateRouteSequence(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_ROUTE_SEQUENCE_SUCCESS,
      value: response,
    })
    yield put({
      type: actions.NP_GET_ROUTE_BY_TRADE_ID,
    ...
    yield put({
      type: actions.NP_UPDATE_ROUTE_SEQUENCE_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* updateRouteStatus(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_ROUTE_STATUS_SUCCESS,
      value: response,
    })
    yield put({
      type: actions.NP_GET_ROUTE_BY_TRADE_ID,
    ...
    yield put({
      type: actions.NP_UPDATE_ROUTE_STATUS_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* getRatesByTradeId(values) {
  try {
    ...
    yield put({
      type: actions.NP_GET_RATES_BY_TRADE_ID_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_GET_RATES_BY_TRADE_ID_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* getFeesByTradeId(values) {
  try {
    ...
    yield put({
      type: actions.NP_GET_FEES_BY_TRADE_ID_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_GET_FEES_BY_TRADE_ID_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* getTradeRate(values) {
  try {
    ...
    yield put({
      type: actions.NP_GET_RATE_SUCCESS,
      value: response,
    })
    notification.success({
    ...
    NProgress.done()
    yield put({
      type: actions.NP_GET_RATE_FAILURE,
      value: err,
    })
...
export function* createRateRecord(values) {
  ...
  try {
    ...
    yield put({
      type: actions.NP_CREATE_RATE_RECORD_SUCCESS,
      value: response,
    })
    ...
    NProgress.done()
    yield put({
      type: actions.NP_CREATE_RATE_RECORD_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* updateTradeSellRate(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_SELL_RATE_SUCCESS,
      value: response,
    })
    // yield put({
    //   type: actions.NP_GET_RATES_BY_TRADE_ID,
    ...
    yield put({
      type: actions.NP_UPDATE_SELL_RATE_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* updateTradeFee(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_FEE_SUCCESS,
      value: response,
    })
    yield put({
      type: actions.NP_GET_FEES_BY_TRADE_ID,
    ...
    yield put({
      type: actions.NP_UPDATE_FEE_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* updateTradeIntroducerFee(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_INTRODUCERS_CLIENT_SUCCESS,
      value: response,
    })
    yield put({
      type: actions.NP_GET_FEES_BY_TRADE_ID,
    ...
    yield put({
      type: actions.NP_UPDATE_INTRODUCERS_CLIENT_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* getDepositSlipsByTradeId(values) {
  try {
    ...
    yield put({
      type: actions.NP_GET_DEPOSIT_SLIPS_BY_TRADE_ID_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_GET_DEPOSIT_SLIPS_BY_TRADE_ID_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* updateTradeDetails(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_TRADE_DETAILS_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_UPDATE_TRADE_DETAILS_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* getIntroducerCommision(values) {
  try {
    ...
    yield put({
      type: actions.NP_GET_INTRODUCER_COMMISION_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_GET_INTRODUCER_COMMISION_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* getTradePcMargin(values) {
  try {
    ...
    yield put({
      type: actions.NP_GET_TRADE_PC_MARGIN_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_GET_TRADE_PC_MARGIN_FAILURE,
      value: err,
    })
    notification.error({
      message: err.response.data.message,
...
export function* updatePcMarginInFees(values) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_FEES_PC_MARGIN_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_UPDATE_FEES_PC_MARGIN_FAILURE,
      value: err,
    })
    notification.error({
...
export function* createManualRate(values) {
  try {
    ...
    yield put({
      type: actions.NP_CREATE_MANUAL_RATE_SUCCESS,
      value: response,
    })
    if (values.value.transactionId) {
      yield put({
        type: transactionAction.NP_GET_TXN_RATES_BY_TXN_ID,
    ...
    yield put({
      type: actions.NP_CREATE_MANUAL_RATE_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* createManualFees(values) {
  try {
    ...
    yield put({
      type: actions.NP_CREATE_MANUAL_FEES_SUCCESS,
      value: response,
    })
    if (values.value.transactionId) {
      yield put({
        type: transactionAction.NP_GET_TXN_FEES_BY_TXN_ID,
        value: values.value.transactionId,
        token: values.token,
      })
    }
...
export function* deleteTradeRates(values) {
  try {
    ...
    yield put({
      type: actions.NP_DELETE_TRADE_RATE_SUCCESS,
      value: response,
    })
    ...
    yield put({
      type: actions.NP_DELETE_TRADE_RATE_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* deleteTradeFee(values) {
  try {
    ...
    yield put({
      type: actions.NP_DELETE_TRADE_FEES_SUCCESS,
      value: response,
    })
    if (values.values.tradeId) {
      yield put({
    ...
    yield put({
      type: actions.NP_DELETE_TRADE_FEES_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* deleteDepositSlip(values) {
  ...
  try {
    ...
    yield put({
      type: actions.NP_DELETE_DEPOSIT_SLIP_SUCCESS,
      value: id,
    })
  } catch (err) {
    yield put({
      type: actions.NP_DELETE_DEPOSIT_SLIP_FAILURE,
      value: err,
    })
  }
}
...
export function* updateBackDatedTrade(value) {
  try {
    ...
    yield put({
      type: actions.NP_UPDATE_BACKDATED_TRADE_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_UPDATE_BACKDATED_TRADE_FAILURE,
      value: err,
    })
  }
}
...
export default function* rootSaga() {
  yield all([
    takeLatest(actions.NP_UPDATE_BACKDATED_TRADE, updateBackDatedTrade),
    takeLatest(actions.NP_DELETE_DEPOSIT_SLIP, deleteDepositSlip),
    takeLatest(actions.NP_GET_TRADE_DETAILS_BY_ID, getTradeDetailsById),
    takeLatest(actions.NP_GET_ROUTE_BY_TRADE_ID, getRouteByTradeId),
    takeLatest(actions.NP_UPDATE_ROUTE_VALUE, updateRouteById),
    takeLatest(actions.NP_UPDATE_SELECTED_CLIENT, updateTradeClient),
    takeLatest(actions.NP_UPDATE_SOURCE_DETAILS, updateSourceDetails),
    takeLatest(actions.NP_UPDATE_BENEFICIARY_DETAILS, updateBeneficiaryDetails),
    takeLatest(actions.NP_UPDATE_DEPOSITED_AMOUNT, updateDepositDetails),
    takeLatest(actions.NP_UPDATE_TRADE_AMOUNT, updateTradeAmountAsDeposit),
    takeLatest(actions.NP_CONFIRM_FINAL_FUNDS, confirmFinalFundsByClient),
    takeLatest(actions.NP_CREATE_ROUTE, autoCreateRoute),
    takeLatest(actions.NP_CREATE_MANUAL_ROUTE, createManualRoute),
    takeLatest(actions.NP_UPDATE_ROUTE_ON_CANCEL_TXN, updateRouteOnCancelTxn),
    takeLatest(actions.NP_UPDATE_ROUTE_ON_DELETE_TXN, updateRouteOnDeleteTxn),
    takeLatest(actions.NP_UPDATE_ROUTE_SEQUENCE, updateRouteSequence),
    takeLatest(actions.NP_UPDATE_ROUTE_STATUS, updateRouteStatus),
    takeLatest(actions.NP_GET_RATES_BY_TRADE_ID, getRatesByTradeId),
    takeLatest(actions.NP_GET_FEES_BY_TRADE_ID, getFeesByTradeId),
    takeLatest(actions.NP_GET_RATE, getTradeRate),
    takeLatest(actions.NP_CREATE_RATE_RECORD, createRateRecord),
    takeLatest(actions.NP_UPDATE_SELL_RATE, updateTradeSellRate),
    takeLatest(actions.NP_UPDATE_FEE, updateTradeFee),
    takeLatest(actions.NP_UPDATE_INTRODUCER_FEE, updateTradeIntroducerFee),
    takeLatest(actions.NP_GET_DEPOSIT_SLIPS_BY_TRADE_ID, getDepositSlipsByTradeId),
    takeLatest(actions.NP_UPDATE_TRADE_DETAILS, updateTradeDetails),
    takeLatest(actions.NP_GET_INTRODUCER_COMMISION, getIntroducerCommision),
    takeLatest(actions.NP_GET_TRADE_PC_MARGIN, getTradePcMargin),
    takeLatest(actions.NP_UPDATE_FEES_PC_MARGIN, updatePcMarginInFees),
    takeLatest(actions.NP_CREATE_MANUAL_RATE, createManualRate),
    takeLatest(actions.NP_CREATE_MANUAL_FEES, createManualFees),
    takeLatest(actions.NP_DELETE_TRADE_RATE, deleteTradeRates),
    takeLatest(actions.NP_DELETE_TRADE_FEES, deleteTradeFee),
    takeLatest(actions.NP_CONFIRM_EXISTING_SELL_RATE, confirmExistingSellRate),
    takeLatest(routingEngineAction.NP_HANDLE_ON_ROUTE_CHANGE, onRouteChange),
  ])
}
