...
import routeEngineActions from '../routeEngine/actions'
...
export default function tradeReducer(state = initialState, action) {
  switch (action.type) {
    case actions.NP_UPDATE_BENEFICIARY_DETAILS_TEMP:
      return {
        ...state,
        beneficiary: {},
      }
    case actions.NP_UPDATE_BACKDATED_TRADE_SUCCESS:
      return {
        ...state,
        ...action.value,
      }

    case actions.NP_UPDATE_BACKDATED_TRADE_FAILURE:
      return {
        ...state,
      }

    case actions.NP_UPDATE_CURRENT_TRADE_ID:
      return {
        ...state,
        tradeId: action.value,
      }

    case actions.NP_UPDATE_CURRENT_CHANNEL_DETAILS:
      return {
        ...state,
        chat: {
          ...state.chat,
    ...
    case actions.NP_UPDATE_BENEFICIARY_DETAILS_SUCCESS:
      return {
        ...state,
        ...action.value,
    ...
    case actions.NP_GET_TRADE_DETAILS_BY_ID:
      return {
        ...initialState,
        tradeLoading: true,
        routeEngineData: [],
    ...
    case actions.NP_GET_TRADE_DETAILS_BY_ID_SUCCESS: {
    ...
    case actions.NP_GET_ROUTE_BY_TRADE_ID_SUCCESS:
      return {
        ...state,
        routeEngineData: action.value,
      }

    case actions.NP_ADD_NEW_ROUTE_DATA:
      return {
        ...state,
        routeEngineData: [...state.routeEngineData, action.value],
      }

    case actions.NP_CHANGE_EDIT_MODE:
      return {
        ...state,
        isEditMode: !action.value,
      }

    case actions.NP_CHANGE_CHAT_MODE:
      return {
        ...state,
        isChatSelected: action.value,
      }

    case actions.NP_UPDATE_SELECTED_CLIENT_SUCCESS:
      return {
        ...state,
        ...action.value,
        beneficiary: {
    ...
    case actions.NP_UPDATE_SOURCE_DETAILS_SUCCESS:
      return {
        ...state,
        ...action.value,
        beneficiary: action.value.cryptoBeneficiary
    ...
    case actions.NP_SELECTED_INTRODUCERS_CLIENT:
      return {
        ...state,
        selectedIntroducerClient: action.value,
      }

    case actions.NP_ENTERED_DEPOSIT_CONFIRMATION_AMOUNT:
      return {
        ...state,
    ...
    case actions.NP_UPDATE_TRADE_AMOUNT_SUCCESS:
      return {
        ...state,
        ...action.value,
      }

    case actions.NP_SELECTED_DEPOSIT_CONFIRMATION_DATE:
      return {
        ...state,
        progressLogs: {
          ...state.progressLogs,
    ...
    case actions.NP_UPDATE_DEPOSITED_AMOUNT:
      return {
        ...state,
        conformDepositLoader: true,
      }
    case actions.NP_UPDATE_DEPOSITED_AMOUNT_SUCCESS:
      return {
        ...state,
        ...action.value,
    ...
    case actions.NP_UPDATE_DEPOSITED_AMOUNT_FAILURE:
      return {
        ...state,
        conformDepositLoader: false,
      }

    case actions.NP_UPDATE_TRADE_DETAILS:
      return {
        ...state,
        tradeValuesUpdateLoader: true,
      }
    case actions.NP_UPDATE_TRADE_DETAILS_SUCCESS:
      return {
        ...state,
        ...action.value,
        tradeValuesUpdateLoader: false,
      }
    case actions.NP_UPDATE_TRADE_DETAILS_FAILURE:
      return {
        ...state,
        tradeValuesUpdateLoader: false,
      }

    case actions.NP_ENTERED_FUNDS_RECEIPT_CONFIRMATION_AMOUNT:
      return {
        ...state,
        fundReceiptConfirmAmountByClient: action.value,
      }

    case actions.NP_SELECTED_FUNDS_RECEIPT_CONFIRMATION_DATE:
      return {
        ...state,
        fundReceiptConfirmDateByClient: action.value,
      }

    case actions.NP_CONFIRM_FINAL_FUNDS:
      return {
        ...state,
        confirmFundsLoader: true,
      }
    case actions.NP_CONFIRM_FINAL_FUNDS_SUCCESS:
      return {
        ...state,
        ...action.value,
    ...
    case actions.NP_CONFIRM_FINAL_FUNDS_FAILURE:
      return {
        ...state,
        confirmFundsLoader: false,
      }

    // case actions.NP_UPDATE_CS_CURRENT_TRADE: {
    ...
    case actions.NP_CREATE_ROUTE_SUCCESS:
      return {
        ...state,
        routeEngineData: [...state.routeEngineData, action.value],
      }

    case actions.NP_CREATE_MANUAL_ROUTE:
      return {
        ...state,
        createManualRouteLoading: true,
      }
    case actions.NP_CREATE_MANUAL_ROUTE_SUCCESS:
      return {
        ...state,
        routeEngineData: [...state.routeEngineData, action.value],
        createManualRouteLoading: false,
      }
    case actions.NP_CREATE_MANUAL_ROUTE_FAILURE:
      return {
        ...state,
        createManualRouteLoading: false,
      }

    case actions.NP_CREATE_MANUAL_RATE:
      return {
        ...state,
        createManualRateLoading: true,
      }
    case actions.NP_CREATE_MANUAL_RATE_SUCCESS:
      return {
        ...state,
        tradeSellRates: [...state.tradeSellRates, action.value],
        createManualRateLoading: false,
      }
    case actions.NP_CREATE_MANUAL_RATE_FAILURE:
      return {
        ...state,
        createManualRateLoading: false,
      }

    case actions.NP_CREATE_MANUAL_FEES:
      return {
        ...state,
        createManualFeesLoading: true,
      }
    case actions.NP_CREATE_MANUAL_FEES_SUCCESS:
      return {
        ...state,
        tradeFees: [...state.tradeFees, action.value],
        createManualFeesLoading: false,
      }
    case actions.NP_CREATE_MANUAL_FEES_FAILURE:
      return {
        ...state,
        createManualFeesLoading: false,
      }

    case routeEngineActions.NP_UPDATE_ROUTE_DETAILS_SUCCESS: {
    ...
    case actions.NP_UPDATE_ROUTE_ON_CANCEL_TXN_SUCCESS: {
      const newArray = updateObjInArray(state.routeEngineData, action.value)
      return {
        ...state,
        routeEngineData: newArray,
    ...
    case actions.NP_UPDATE_ROUTE_ON_DELETE_TXN_SUCCESS: {
      const newArray = updateObjInArray(state.routeEngineData, action.value)
      return {
        ...state,
        routeEngineData: newArray,
    ...
    case actions.NP_UPDATE_SOURCE_CURRENCY:
      return {
        ...state,
        sourceCurrency: action.value,
      }

    case actions.NP_UPDATE_SOURCE_AMOUNT:
      return {
        ...state,
    ...
    case actions.NP_UPDATE_SELECTED_SOURCE_DETAILS:
      return {
        ...state,
    ...
    case actions.NP_CHANGE_NEW_CALCULATION:
      return {
        ...state,
        isNewCalculation: action.value,
      }

    case actions.NP_APPLY_PRECISION_CHECK:
      return {
        ...state,
        isPrecisionApply: action.value,
      }

    case actions.NP_ENTERED_PRECISION:
      return {
        ...state,
        precision: action.value,
      }

    case actions.NP_APPLY_XE_DATE_TIME_CHECK:
      return {
        ...state,
        isXeDateTimeApply: action.value,
      }

    case actions.NP_UPDATE_XE_DATE_TIME:
      return {
        ...state,
        rateAppliedAt: action.value,
      }

    case actions.NP_GET_RATE:
      return {
        ...state,
        isRateFetched: false,
      }

    case actions.NP_GET_RATE_SUCCESS:
      return {
        ...state,
    ...
    case actions.NP_GET_RATES_BY_TRADE_ID:
      return {
        ...state,
      }
    case actions.NP_GET_RATES_BY_TRADE_ID_SUCCESS:
      return {
        ...state,
        tradeSellRates: action.value,
        ...action.value.sellRates,
      }
    case actions.NP_GET_RATES_BY_TRADE_ID_FAILURE:
      return {
        ...state,
      }

    case actions.NP_UPDATE_SELL_RATE:
      return {
        ...state,
      }
    case actions.NP_UPDATE_SELL_RATE_SUCCESS: {
      const { value } = action
    ...
    case actions.NP_UPDATE_SELL_RATE_FAILURE:
      return {
        ...state,
      }

    case actions.NP_GET_FEES_BY_TRADE_ID_SUCCESS:
      return {
        ...state,
        tradeFees: action.value.fees,
      }

    case actions.NP_CREATE_RATE_RECORD_SUCCESS:
      return {
        ...state,
        tradeSellRates: [...state.tradeSellRates, action.value],
        rateDetails: action.value,
    ...
    case actions.NP_GET_DEPOSIT_SLIPS_BY_TRADE_ID_SUCCESS:
      return {
        ...state,
    ...
    case actions.NP_UPDATE_CURRENT_TRADE_CLIENT:
      return {
        ...state,
        introducerCommission: {
    ...
    case actions.NP_CHANGE_REVENUE:
      return {
        ...state,
        introducerCommission: {
          ...state.introducerCommission,
    ...
    case actions.NP_CHANGE_SETTLEMENT:
      return {
        ...state,
        introducerCommission: {
          ...state.introducerCommission,
    ...
    case actions.NP_CHANGE_DEPOSIT:
      return {
        ...state,
        introducerCommission: {
          ...state.introducerCommission,
    ...
    case actions.NP_UPDATE_FEES_PC_MARGIN_SUCCESS:
      return {
        ...state,
        pcMarginDetails: {
    ...
    case actions.NP_GET_TRADE_PC_MARGIN_SUCCESS:
      return {
        ...state,
        pcMarginDetails: {
          ...state.pcMarginDetails,
    ...
    case actions.NP_ENTERED_PC_MARGIN_PERCENTAGE:
      return {
        ...state,
        pcMarginDetails: {
          ...state.pcMarginDetails,
    ...
    case actions.NP_GET_INTRODUCER_COMMISION_SUCCESS:
      return {
        ...state,
        introducerCommission: {
          ...state.introducerCommission,
    ...
    case actions.NP_GET_INTRODUCER_COMMISION_FAILURE:
      return {
        ...state,
        isCommissionFetched: false,
      }

    case actions.NP_UPDATE_INTRODUCERS_CLIENT_SUCCESS:
      return {
        ...state,
        isCommisionConfirmed: true,
      }
    case actions.NP_UPDATE_INTRODUCERS_CLIENT_FAILURE:
      return {
        ...state,
        isCommisionConfirmed: false,
      }
    ...
    case actions.NP_SHOW_NEXT_STEP_NOTIFICATION:
      return {
        ...state,
        showNextStepNotification: true,
      }
    case actions.NP_CLOSE_NEXT_STEP_NOTIFICATION:
      return {
        ...state,
        showNextStepNotification: false,
      }
    case actions.NP_DELETE_TRADE_RATE:
      return {
        ...state,
        deleteTradeRateLoading: true,
      }
    case actions.NP_DELETE_TRADE_RATE_SUCCESS:
      return {
        ...state,
        deleteTradeRateLoading: false,
      }
    case actions.NP_DELETE_TRADE_RATE_FAILURE:
      return {
        ...state,
        deleteTradeRateLoading: false,
      }

    case actions.NP_DELETE_TRADE_FEES:
      return {
        ...state,
        deleteTradeFeesLoading: true,
      }
    case actions.NP_DELETE_TRADE_FEES_SUCCESS:
      return {
        ...state,
        deleteTradeFeesLoading: false,
      }
    case actions.NP_DELETE_TRADE_FEES_FAILURE:
      return {
        ...state,
        deleteTradeFeesLoading: false,
      }
    case actions.NP_DELETE_DEPOSIT_SLIP:
      return {
        ...state,
        deletionLoadingTrade: true,
      }
    case actions.NP_DELETE_DEPOSIT_SLIP_SUCCESS:
      return {
        ...state,
        paySlips: state.paySlips.filter(file => file.id !== action.value),
        deletionLoadingTrade: false,
      }
    case actions.NP_DELETE_DEPOSIT_SLIP_FAILURE:
      return {
        ...state,
        deletionLoadingTrade: false,
      }
