...
export function* getChatAccessToken({ values }) {
  try {
    ...
    yield put({
      type: actions.NP_GET_CHAT_TOKEN_SUCCESS,
      value: response,
    })
    yield call(getChatUser, values, response)
  } catch (err) {
    yield put({
      type: actions.NP_GET_CHAT_TOKEN_FAILURE,
      payload: err,
    })
    // notification.error({
...
export function* getChatUser(values, token) {
  try {
    ...
    yield put({
      type: actions.NP_GET_CHAT_USER_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_GET_CHAT_USER_FAILURE,
      payload: err,
    })
  }
}
...
export function* createChatChannel(values) {
  try {
    ...
    yield put({
      type: actions.NP_CREATE_CHAT_CHANNEL_SUCCESS,
      value: response,
    })
    ...
    yield put({
      type: tradeActions.NP_UPDATE_TRADE_STATUS,
      value: tradeData,
    ...
    yield put({
      type: actions.NP_CREATE_CHAT_CHANNEL_FAILURE,
      payload: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* createManualChatChannel(values) {
  try {
    ...
    yield put({
      type: actions.NP_CREATE_MANUAL_CHAT_CHANNEL_SUCCESS,
      value: response,
    })
    ...
    yield put({
      type: actions.NP_CREATE_MANUAL_CHAT_CHANNEL_FAILURE,
      payload: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* allMessages(values) {
  try {
    ...
    yield put({
      type: actions.NP_GET_ALL_MESSAGES_SUCCESS,
      value: response,
      lastMsgId: lastMsg.id,
    })
  } catch (err) {
    yield put({
      type: actions.NP_GET_ALL_MESSAGES_FAILURE,
      value: err.response,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* getallChannelMembers(values) {
  try {
    ...
    yield put({
      type: actions.NP_GET_CHANNEL_MEMBERS_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_GET_CHANNEL_MEMBERS_FAILURE,
      value: err.response,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* endTradeChannel(values) {
  try {
    ...
    yield put({
      type: actions.NP_END_CHANNEL_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_END_CHANNEL_FAILURE,
      value: err.response,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* getArchivedMessages(values) {
  try {
    ...
    yield put({
      type: actions.NP_GET_ARCHIVED_MESSAGES_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_GET_ARCHIVED_MESSAGES_FAILURE,
      value: err.response,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* triggerAgentMessages(values) {
  try {
    ...
    yield put({
      type: actions.NP_TRIGGER_AGENT_MESSAGE_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.NP_TRIGGER_AGENT_MESSAGE_FAILURE,
      value: err.response,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* addMemberToChannel(values) {
  try {
    ...
    yield put({
      type: actions.NP_ADD_MEMBER_TO_CHAT_SUCCESS,
      value: response,
    })
    yield put({
    ...
    yield put({
      type: actions.NP_ADD_MEMBER_TO_CHAT_FAILURE,
      value: err.response,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* removeMemberFromChannel(values) {
  try {
    ...
    yield put({
      type: actions.NP_REMOVE_MEMBER_SUCCESS,
      value: response,
    })
    yield put({
      type: actions.NP_GET_CHANNEL_MEMBERS,
    ...
    yield put({
      type: actions.NP_REMOVE_MEMBER_FAILURE,
      value: err.response,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* initialiseTwilioChatClient(values) {
  ...
  try {
    ...
    yield put({
      type: actions.NP_INITIALISE_TWILIO_CHAT_CLIENT_SUCCESS,
      payload: { chatClient },
    })
    ...
    yield put({
      type: actions.NP_INITIALISE_TWILIO_CHAT_CLIENT_FAILURE,
      payload: err,
    })
  }
}
...
//     yield put({
//       type: actions.NP_SET_STREAMING_CHANNELS_SUCCESS,
//       payload: { activeTradeStreamingChannel },
//     })
//   } catch (err) {
//     yield put({
//       type: actions.NP_SET_STREAMING_CHANNELS_FAILURE,
//       payload: err,
//     })
//   }
// }
...
export function* setCurrentTradeChatChannel(values) {
  ...
  try {
    ...
    yield put({
      type: actions.NP_SET_CURRENT_TRADE_CHAT_CHANNEL_SUCCESS,
      payload: { activeCurrentTradeChatChannel },
    })
  } catch (err) {
    yield put({
      type: actions.NP_SET_CURRENT_TRADE_CHAT_CHANNEL_FAILURE,
      payload: err,
    })
  }
}
...
export default function* rootSaga() {
  yield all([
    takeLatest(actions.NP_GET_CHAT_TOKEN, getChatAccessToken),
    takeLatest(actions.NP_GET_CHAT_USER, getChatUser),
    takeLatest(actions.NP_GET_ALL_MESSAGES, allMessages),
    takeLatest(actions.NP_GET_CHANNEL_MEMBERS, getallChannelMembers),
    takeLatest(actions.NP_END_CHANNEL, endTradeChannel),
    takeLatest(actions.NP_GET_ARCHIVED_MESSAGES, getArchivedMessages),
    takeLatest(actions.NP_TRIGGER_AGENT_MESSAGE, triggerAgentMessages),
    takeLatest(actions.NP_ADD_MEMBER_TO_CHAT, addMemberToChannel),
    takeLatest(actions.NP_REMOVE_MEMBER, removeMemberFromChannel),
    takeLatest(actions.NP_CREATE_CHAT_CHANNEL, createChatChannel),
    takeLatest(actions.NP_CREATE_MANUAL_CHAT_CHANNEL, createManualChatChannel),
    takeLatest(actions.NP_INITIALISE_TWILIO_CHAT_CLIENT, initialiseTwilioChatClient),
    // takeLatest(actions.NP_SET_STREAMING_CHANNELS, setStreamingChannels),
    takeLatest(actions.NP_SET_CURRENT_TRADE_CHAT_CHANNEL, setCurrentTradeChatChannel),
  ])
}
