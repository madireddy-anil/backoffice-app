...
export default function newTradeReducer(state = initialState, action) {
  switch (action.type) {
    case actions.NP_INITIATE_NEW_TRADE:
      return {
        ...state,
        ...initialState,
      }
    case actions.NP_GET_BENEFICIARY_CRYPTO_BY_CLIENT_ID:
      return {
        ...state,
        isBeneficiaryFetching: true,
      }
    case actions.NP_GET_BENEFICIARY_CRYPTO_BY_CLIENT_ID_SUCCESS:
      return {
        ...state,
        isBeneficiaryFetching: false,
      }
    case actions.NP_GET_BENEFICIARY_CRYPTO_BY_CLIENT_ID_FAILURE:
      return {
        ...state,
        isBeneficiaryFetching: false,
      }
    case actions.NP_GET_BENEFICIARY_BY_CLIENT_ID:
      return {
        ...state,
        isBeneficiaryFetching: true,
      }
    case actions.NP_GET_BENEFICIARY_BY_CLIENT_ID_SUCCESS:
      return {
        ...state,
        isBeneficiaryFetching: false,
      }
    case actions.NP_GET_BENEFICIARY_BY_CLIENT_ID_FAILURE:
      return {
        ...state,
        isBeneficiaryFetching: false,
      }
    case actions.NP_HANDLE_SETTLEMENT_PREFERENCE:
      return {
        ...state,
        isSettlementPreferenceSelected: action.value,
      }
    case actions.NP_HANDLE_SETTLEMENT_PREFERENCE_FIAT:
      return {
        ...state,
        isCrypto: false,
      }
    case actions.NP_HANDLE_SETTLEMENT_PREFERENCE_CRYPTO:
      return {
        ...state,
        isCrypto: true,
      }
    case actions.NP_UPDATE_INTRODUCER_OR_MERCHANT:
      return {
        ...state,
        ...initialState,
        introducerOrMerchant: action.value,
      }
    case actions.NP_UPDATE_SELECTED_INTRODUCER:
      return {
        ...state,
    ...
    case actions.NP_REMOVE_INTRODUCER:
      return {
        ...state,
        selectedIntroducer: {},
        introducerOrMerchantProfile: '',
    ...
    case actions.NP_UPDATE_SELECTED_MERCHANT:
      return {
        ...state,
    ...
    case actions.NP_REMOVE_MERCHANT:
      return {
        ...state,
        selectedMerchant: {},
        selectedIntroducerClient: {},
    ...
    case actions.NP_UPDATE_SELECTED_INTRODUCER_CLIENT:
      return {
        ...state,
    ...
    case actions.NP_REMOVE_INTRODUCER_CLIENT:
      return {
        ...state,
        selectedIntroducerClient: {},
        selectedMerchantClient: {},
    ...
    case actions.NP_UPDATE_SELECTED_MERCHANT_CLIENT:
      return {
        ...state,
    ...
    case actions.NP_REMOVE_MERCHANT_CLIENT:
      return {
        ...state,
        selectedMerchantClient: {},
        selectedBeneficiary: {},
    ...
    case actions.NP_UPDATE_DEPOSIT_CURRENCY:
      return {
        ...state,
        sourceCurrency: action.value,
      }
    case actions.NP_UPDATE_DEPOSIT_AMOUNT:
      return {
        ...state,
    ...
    case actions.NP_SELECTED_TRADE_BENEFICIARY:
      return {
        ...state,
        selectedBeneficiary: action.value,
      }
    case actions.NP_UPDATE_ACCOUNT_PREFERENCE:
      return {
        ...state,
        depositAccountPreference: action.value,
      }
    case actions.NP_REMOVE_BENEFICIARY:
      return {
        ...state,
        selectedBeneficiary: {},
      }
    case actions.NP_CREATE_TRADE:
      return {
        ...state,
        loading: true,
      }
    case actions.NP_CREATE_TRADE_SUCCESS:
      return {
        ...state,
        loading: false,
        tradeConfirmed: true,
    ...
    case actions.NP_CREATE_TRADE_FAILURE:
      return {
        ...state,
        loading: false,
        tradeConfirmed: false,
