...
export default function tradesReducer(state = initialState, action) {
  switch (action.type) {
    case actions.NP_HANDLE_TRADES_FILTERS:
      return {
        ...state,
        appliedTradeFilters: action.value,
      }
    case actions.NP_GET_TRADES:
      return {
        ...state,
        loading: true,
        isDownloadDisabled: true,
      }
    case actions.NP_GET_TRADES_SUCCESS:
      return {
        ...state,
    ...
    case actions.NP_GET_TRADES_FAILURE:
      return {
        ...state,
        totalTransfer: [],
        loading: false,
    ...
    case actions.NP_UPDATE_TRADES_SUCCESS:
      return {
        ...state,
        pagination: action.tradesData,
        loading: false,
      }
    case actions.NP_UPDATE_TRADES_FAILURE:
      return {
        ...state,
        loading: false,
      }

    case actions.NP_UPDATE_DAY_FROM:
      return {
        ...state,
        dateFrom: action.dayFrom,
      }
    case actions.NP_UPDATE_DAY_TO:
      return {
        ...state,
        dateTo: action.dayTo,
      }
    case actions.NP_CLEAR_DATES:
      return {
        ...state,
        dateFrom: '',
        dateTo: '',
      }
    case actions.NP_SET_ACTIVE_CHANNEL:
      return {
        ...state,
        activeChannel: action.value,
      }
    // case actions.NP_INSERT_CS_NEW_TRADE: {
    ...
    case actions.NP_GET_TRADES_BULK_DOWNLOAD:
      return {
        ...state,
        isDownloadDisabled: true,
        loading: true,
      }
    case actions.NP_GET_TRADES_BULK_DOWNLOAD_SUCCESS:
      return {
        ...state,
        totalTransfer: action.value.trades,
        allTradesDownload: action.value.trades,
    ...
    case actions.NP_GET_TRADES_BULK_DOWNLOAD_FAILURE:
      return {
        ...state,
        isDownloadDisabled: false,
        loading: false,
      }
    case actions.NP_HANDLE_TRADES_PAGINATION:
      return {
        ...state,
        pagination: action.value,
      }
    case actions.NP_UPDATE_DOWNLOADABLE_DATA:
      return {
        ...state,
        allTradesDownload: action.value,
        totalTradesDownload: action.value.length,
      }
    // case actions.NP_UPDATE_CS_TRDAE: {
    //   const { trade, changeStramIndex } = action.payload
    //   if (changeStramIndex !== state.previousChangeStreamIndex) {
    //     const totalTransfer = [...state.totalTransfer]
    //     const index = totalTransfer.findIndex(e => e.id === trade.id)
