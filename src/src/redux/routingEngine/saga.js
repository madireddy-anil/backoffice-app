...
export function* getAllRoutes(values) {
  try {
    ...
    yield put({
      type: actions.GET_ALL_ROUTES_SUCCESS,
      value: response,
    })
  } catch (e) {
    yield put({
      type: actions.GET_ALL_ROUTES_FAILURE,
    })
    notification.error({
...
export function* updateRouteDetails(values) {
  try {
    ...
    yield put({
      type: actions.UPDATE_ROUTE_DETAILS_SUCCESS,
      value: response,
    })
  } catch (err) {
    yield put({
      type: actions.UPDATE_ROUTE_DETAILS_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* deleteRoutes(values) {
  try {
    ...
    yield put({
      type: actions.DELETE_ROUTES_SUCCESS,
      value: response,
    })
    yield put({
    ...
    yield put({
      type: actions.DELETE_ROUTES_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* onDeleteRoutes(values) {
  try {
    ...
    yield put({
      type: actions.DELETE_ROUTE_TRADE_PAGE_SUCCESS,
      value: response,
    })
    yield put({
      type: tradeAction.GET_ROUTE_BY_TRADE_ID,
      value: values.tradeId,
      token: values.token,
    })
  } catch (err) {
    yield put({
      type: actions.DELETE_ROUTE_TRADE_PAGE_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export function* bulkDeleteRoutes(values) {
  try {
    ...
    yield put({
      type: actions.BULK_DELETE_ROUTES_SUCCESS,
      value: response,
    })
    yield put({
      type: actions.GET_ALL_ROUTES,
    ...
    yield put({
      type: actions.BULK_DELETE_ROUTES_FAILURE,
      value: err,
    })
    notification.error({
      message: globalMessages.errorMessage,
...
export default function* rootSaga() {
  yield all([
    takeEvery(actions.GET_ALL_ROUTES, getAllRoutes),
    takeEvery(actions.UPDATE_ROUTE_DETAILS, updateRouteDetails),
    takeLatest(actions.DELETE_ROUTES, deleteRoutes),
    takeLatest(actions.DELETE_ROUTE_TRADE_PAGE, onDeleteRoutes),
    takeLatest(actions.BULK_DELETE_ROUTES, bulkDeleteRoutes),
  ])
}
